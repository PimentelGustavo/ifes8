...
%%% Atualizado por: Gustavo Cardoso Pimentel em 11 de agosto de 2026 (Adequação às normas Ifes 2024 - 9ª edição)
%%% Data de criação: 2021-07-01 | Data de atualização: 2026-08-11
%%%
...
% \usepackage{microtype}          % Desativado: causa timeout no Overleaf com TeX Live 2025
\usepackage{morefloats}         % permite mais floats
\usepackage{blindtext}          % para gerar texto aleatório (dummy text)
\makeatletter
\let\blindtext@brazil\blindtext@english
\let\blindtext@brazilian\blindtext@english
\makeatother
\DeclareFontShape{T1}{lmr}{b}{it}{<->ssub * lmr/b/sl}{}
\usepackage{tikz}
...
\begin{fichacatalografica}
  ...
  \begin{center}
    ...
    \vspace*{3mm}
    {\footnotesize Bibliotecário(a) responsável: Nome Completo -- CRB X/XXXX}
  \end{center}
...
\begin{folhadeaprovacao}
  ...
  % \vspace{-1cm}%
  \begin{center}
    Aprovado em 11 de agosto de 2026.\\[15mm]
...
%   \imprimirlocal, 11 de agosto de 2026.
...
documento (agosto de 2026), a norma mais recente é a 9ª edição,
publicada em 2024 \cite{Ifes2024}.
...
\cite{Ifes2024}, e se concentrar no que é novo e/ou diferente na
classe \ifestex.
...
conforme estabelecido pelas normas do Ifes \cite[pp.~20]{Ifes2024}.

A opção \texttt{a4paper} estabelece o uso de papel tamanho A4,
conforme definido em \cite[pp.~19]{Ifes2024}.
...
indicadas 4.3.7.1 das normas do Ifes \cite[p.~34]{Ifes2024}.
% , e a
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[transform shape]
    ...
    \foreach \number in {9,...,16}{
      \node[draw,circle,inner sep=0.25cm] (N-\number) at
      ({(\number-1)*45+22.5}:5.4cm) {}; 
    }
    \foreach \number in {1,...,15}{
      \pgfmathtruncatemacro{\startnum}{\number+1}
      \foreach \numbera in {\startnum,...,16}{
...
\cite{Ifes2024}, \cite{NBR6024:2012}, \cite{araujo2012},
...
\cite{NBR6028:2003}, \cite{NBR10520:2023}, \cite{NBR14724:2002},
