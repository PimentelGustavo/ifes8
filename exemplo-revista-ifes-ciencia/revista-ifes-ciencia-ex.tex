...
%%% Data de criação: 2026-08-12 | Data de atualização: 2026-08-18
%%%
%%% REVISÃO 2026-08-18:
%%%  - \revistavolume passou a receber só o número do volume; o
%%%    número da edição e o ano agora são campos próprios
%%%    (\revistanumero, \revistaano). A classe compõe sozinha tanto a
%%%    forma curta do cabeçalho corrente ("v.9n.1 2023") quanto a
%%%    forma por extenso da capa ("Volume 9 / Number 1 / Year 2023").
%%%  - Abstract/Keywords agora usam o ambiente `resumoabstract`, que
%%%    garante página própria (mesmo que a capa varie de tamanho) e já
%%%    aplica a fonte 11pt exigida pelo template .docx.
%%% ============================================================

\documentclass[revista,english,oneside]{ifes8}
...
\textbf{<Insert here the descriptive text of the Graphical Abstract (1 to 2 lines, in English)>}
...
\begin{flushright}{\fontsize{10}{12}\selectfont * (insert the e-mail of the corresponding author)}\end{flushright}
...
%% ==================================================================
%% PÁGINA 2 -- Abstract e Keywords (coluna única, fonte 11pt, página
%% própria garantida pelo ambiente `resumoabstract` -- ver ifes8.cls)
%% ==================================================================
