...
\tolerance=2000 \emergencystretch=2.5em \hbadness=10000 \sloppy
...
\raggedleft \color{white}\bfseries \fontsize{13}{16}\selectfont ISSN 2359-4799\\[2pt]
...
\begin{center} \textbf{GRAPHICAL ABSTRACT}
...
{\Large\bfseries PAPER TITLE} \end{center}

\vspace{6mm}
\noindent Author 1 (insert only after
acceptance)\textsuperscript{1}\,\includegraphics[height=2.3mm]{pics/orcid_icon.png}*,
Author 2 (insert only after
acceptance),\textsuperscript{2}\,\includegraphics[height=2.3mm]{pics/orcid_icon.png} and
...
\begin{center} Article submitted in XX/XX/XXXX, accepted in XX/XX/XXXX and published in
XX/XX/XXXX. \end{center}
