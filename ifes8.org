...
#+SUBTITLE: Segundo as Normas para Apresentação de Trabalhos Acadêmicos e Científicos, 9ª edição revista e ampliada
#+AUTHOR: Prof. Dr. Jefferson O. Andrade (Atualizado por Gustavo Cardoso Pimentel em 11 de agosto de 2026)
...
* Revisão de 2026-08-11 (Gustavo Cardoso Pimentel)

** DONE Atualização para as Normas Ifes 2024 (9ª edição)
   - Ajuste do espaçamento de parágrafo (`\parskip=15pt`) e remoção do recuo (`\parindent=0mm`).
   - Inclusão dos campos obrigatórios do Bibliotecário e CRB na Ficha Catalográfica.
   - Atualização das referências normativas para ABNT NBR 10520:2023 e Ifes 2024 (9ª Edição).
...
** DONE Remover caractere com acento na descrição da classe
   ...
   #+begin_example
   \ProvidesClass{ifes8}[2026/08/11 v9.0 Classe de trabalhos academicos do Ifes (Normas 2024)]
   #+end_example
